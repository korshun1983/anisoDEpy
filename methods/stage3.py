...
def run_stage3_matrix_assembly(CompStruct: Any) -> Tuple[Any, Dict]:
    ...
    # =============================================================================
    # 2. Assemble basic matrices (Lx, Ly, Lz, convolutions)
    # =============================================================================
    ...
    for ii_d in range(1, n_domains + 1):
        ...
        domain_elements = CompStruct.FEMatrices['MeshTri'][
            CompStruct.FEMatrices['MeshTri'][:, 10] == ii_d
            ].T
...
def _extract_domain_mesh_props(CompStruct: Any, domain_id: int) -> Dict[str, np.ndarray]:
    ...
    element_mask = CompStruct.FEMatrices['MeshTri'][:, 10] == domain_id
